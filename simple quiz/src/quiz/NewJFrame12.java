...
public class NewJFrame12 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("What is the standard unit of distance in the metric system?");

        jRadioButton1.setText("Feet");

        jRadioButton2.setText("Gauge");

        jRadioButton3.setText("Metre");

        jRadioButton4.setText("Kilometre");
